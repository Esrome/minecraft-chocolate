...
public class BlockSpecialJackOLantern extends Block implements IHasModel {

	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public static final PropertyBool CANDLE = PropertyBool.create("candle");
	protected static final AxisAlignedBB PUMPKIN_BB = new AxisAlignedBB(0.0625D, 0.0D, 0.0625D, 0.9375D, 0.5625, 0.9375D);
	
	public BlockSpecialJackOLantern(String name) 
	{
	...
	{
		return new TileEntityJackOLantern();
	}
	...
	{
		return new BlockStateContainer(this, new IProperty[] {CANDLE,FACING});
	}
