...
public class BlockFenceGateBase extends BlockHorizontal implements IHasModel {
    ...
    public BlockFenceGateBase(Material material, MapColor color, String name, CreativeTabs tab, int harvestLevel, String harvestTool) {
    ...
    {
    	if(this.getMaterial(state)==Material.IRON) {
    		return true;
    	}
        ...
        if(this.getMaterial(this.getDefaultState())==Material.IRON) {
