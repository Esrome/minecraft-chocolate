package esrome.mcchoc.gui.bluestone;
...
public class GUICoalGenerator extends GuiContainer {
	...
	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MODID + ":textures/gui/coal_generator.png");
