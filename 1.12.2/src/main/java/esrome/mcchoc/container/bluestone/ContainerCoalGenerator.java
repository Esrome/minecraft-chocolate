package esrome.mcchoc.container.bluestone;
...
public class ContainerCoalGenerator extends Container {
	...
	public ContainerCoalGenerator(InventoryPlayer player, TileEntityCoalGenerator tileEntityCoalGenerator) 
	{
		this.tileentity = tileEntityCoalGenerator;
		IItemHandler handler = tileEntityCoalGenerator.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null);
